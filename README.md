...
selain itu, 		       pathDP(i,j) = <img src="http://www.sciweavers.org/tex2img.php?eq=%5Csum%20%5Climits_%7Bright%3D0%7D%5E%7Bpapancatur%5Bi%5D%5Bj%5D%7D%20%7Bf%28i%2Bright%2Cj%2B%28N-right%29%29%7D&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="\sum \limits_{right=0}^{papancatur[i][j]} {f(i+right,j+(N-right))}" width="328" height="57" />  	---Rekursif <br />
```
